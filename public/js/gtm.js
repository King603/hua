...
var wh=function(){var a=uh("gac");if(a)return decodeURIComponent(a);var b=Ag(),c=[];ta(b,function(d,e){for(var g=[],h=0;h<e.length;h++)g.push(e[h].Uf);g=rh(g);g.length&&c.push(d+":"+g.join(","))});return c.join(";")},xh=function(a,b,c,d,e){zg(b,c,d,e);var g=vg[wg(b)],h=jh().dc||[],k=!1;if(g&&0<h.length){var l=oc.joined_au=oc.joined_au||{},m=b||"_gcl";if(!l[m])for(var n=0;n<h.length;n++){var q="http://ad.doubleclick.net/ddm/regclk",t=q=q+"?gclid="+h[n]+"&auiddc="+g;Hb.sendBeacon&&Hb.sendBeacon(t)||Ob(t);k=l[m]=
